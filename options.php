...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'desc' => __('To moderate comment, you need to <a href="https://www.google.co.th/search?q=how+to+setup+facebook+app+id">setup Facebook App ID</a>', 'seed_options_theme'),
		'id' => 'facebook_app_id',
		'class' => 'hidden',
		'type' => 'text');
