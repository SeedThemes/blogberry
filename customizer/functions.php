...
<?php
	...
	function theme_styles() {
		if(defined('SEED_KICKSTART') && (SEED_KICKSTART)) {
			wp_register_style('seed-framework', get_template_directory_uri()."/customizer/assets/kickstart/css/kickstart.css", array(), "", "all");
			wp_enqueue_style('seed-framework');
		} else {
			wp_register_style('seed-framework', get_template_directory_uri()."/customizer/assets/bootstrap/bootstrap.min.css", array(), "", "all");
			wp_enqueue_style('seed-framework');
		}

		wp_register_style('seed-font-awesome', get_template_directory_uri()."/customizer/assets/font-awesome.min.css", array("seed-framework"), "", "all");
		wp_enqueue_style('seed-font-awesome');
		wp_register_style('seed', get_template_directory_uri()."/customizer/assets/seed.css", array(), "seed-font-awesome", "all");
